...
var detectNetwork = function(cardNumber) {
  ...
  if (cardNumber.length === 14 && (cardNumber.startsWith('38') || cardNumber.startsWith('39'))) {
    ...
    return 'Visa';
  } else if ((cardNumber.length === 16 || cardNumber.length === 19) && (cardNumber.startsWith('6011') || (cardNumber.slice(0, 3) >= 644 && cardNumber.slice(0, 3) <= 649) || cardNumber.startsWith('65'))) {
    return 'Discover';
